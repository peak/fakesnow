...
class FakeSnowflakeCursor:
    ...
    def _execute(
        ...
        **kwargs: Any,
        ...
        transformed = (
            ...
            .transform(transforms.json_extract_in_string_literals)
            .transform(transforms.json_extract_eq_string_literal)
    ...
    def _describe_as_result_metadata(describe_results: list) -> list[ResultMetadata]:
        ...
        def as_result_metadata(column_name: str, column_type: str, _: str) -> ResultMetadata:
            ...
            if column_type in {"BIGINT", "INTEGER", "HUGEINT"}:
                ...
                # NOTE(selman): Does not resolve https://github.com/tekumara/fakesnow/issues/26
                return ResultMetadata(
